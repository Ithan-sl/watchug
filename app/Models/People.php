...
class People extends Model
{
    ...
    {
        if ($this->image) {
            $path = config('attr.people.path') . ($this->created_at ? $this->created_at->translatedFormat('m-Y') : '') . '/' . $this->image;
        ...
        return $this->image
            ? asset(config('attr.people.path') . ($this->created_at ? $this->created_at->translatedFormat('m-Y') : '') . '/' . $this->image)
            : '';
    }
