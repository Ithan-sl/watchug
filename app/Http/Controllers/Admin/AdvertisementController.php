...
class AdvertisementController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        \Illuminate\Support\Facades\Cache::forget('ad-' . $model->id);
    ...
    public function update(Request $request, $id)
    {
        ...
        \Illuminate\Support\Facades\Cache::forget('ad-' . $model->id);
        \Illuminate\Support\Facades\Cache::forget('ad-5');
        \Illuminate\Support\Facades\Cache::forget('ad-6');

        return redirect()->route('admin.advertisement.edit',$model->id)->with('success', __(':title updated', ['title' => $model->name]));
    }
}
