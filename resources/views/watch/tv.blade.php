    ...
    <div x-data="{selectedStream:'0',trailerOpen:false,iframeSrc: '',downloadOpen:false}">
        <div class="container">
                ...
                <div class="flex-1">
                    ...
                    @if($listing->seasons_count > 0)
                        <a href="#episodes-section"
                           class="mt-3 inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-gray-200 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 transition">
                            <x-ui.icon name="play" class="w-3.5 h-3.5" fill="currentColor"/>
                            {{__('Ver Episódios')}} ↓
                        </a>
                    @endif
                </div>
            ...
            <div class="lg:flex gap-6 xl:gap-12 py-3 relative">
                ...
                <div class="max-w-[16rem] w-full mx-auto hidden lg:block">
                    ...
                    @if($listing->seasons_count > 0)
                        <a href="#episodes-section"
                           class="w-full mt-2 inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-semibold text-gray-200 bg-gray-800 hover:bg-gray-700 rounded-lg border border-gray-700 transition">
                            <x-ui.icon name="play" class="w-4 h-4" fill="currentColor"/>
                            {{__('Ver Episódios')}} ↓
                        </a>
                    @endif
                </div>
            ...
            @if($listing->seasons_count > 0)
            <div id="episodes-section" class="pb-6 scroll-mt-6">
        ...
        <div id="search-modal"
            ...
            <div class="bg-white dark:bg-gray-900 overflow-auto max-w-6xl w-full rounded-xl"
                 @click.outside="trailerOpen = false; iframeSrc = ''" @keydown.escape.window="trailerOpen = false; iframeSrc = ''">
