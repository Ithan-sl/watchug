            ...
            <form method="post">
                ...
                <div class="mb-5">
                    ...
                    <x-form.textarea name="body" placeholder="{{__('Code')}}"
                                     rows="6">{{ old('body', isset($listing) ? $listing->body : '') }}</x-form.textarea>
                    <p class="text-xs text-gray-500 mt-1.5">{{ __('Insira aqui o código do anúncio (HTML, banner, script de popup ou tag de rede de anúncios).') }}</p>
