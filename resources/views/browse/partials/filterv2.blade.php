        ...
        <form method="get"
            ...
            <div class="relative w-full lg:w-auto" x-data="{ open: false}">
                ...
                <div
                    ...
                    <div class="gap-2 flex flex-wrap">
                        @foreach($filterGenres ?? \Illuminate\Support\Facades\Cache::rememberForever('filter-genres-all', fn() => \App\Models\Genre::all()) as $genre)
            ...
            <div class="relative w-full lg:w-auto" x-data="{ open: false}">
                ...
                <div
                    ...
                    <div class="gap-2 flex flex-wrap">
                        @foreach($filterCountries ?? \Illuminate\Support\Facades\Cache::rememberForever('filter-countries-all', fn() => \App\Models\Country::where('filter','active')->get()) as $country)
